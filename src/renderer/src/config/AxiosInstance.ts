...
AxiosInstance.interceptors.response.use(
  ...
  async (error: AxiosError) => {
    ...
    if (
      ...
      try {
        const currentRefreshToken = localStorage.getItem('stonic_cloud_token')
        ...
        if (res.data.refreshToken) {
          localStorage.setItem('stonic_cloud_token', res.data.refreshToken)
        }
        ...
        localStorage.removeItem('stonic_cloud_token')
