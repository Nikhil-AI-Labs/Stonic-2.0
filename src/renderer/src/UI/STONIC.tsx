...
import { getHistory } from '@renderer/services/stonic-ai-brain'
...
const STONIC = (props: StonicProps) => {
      ...
      <div className="h-14 w-full flex items-center justify-between px-6 bg-zinc-950/80 border-b border-white/5 z-50 backdrop-blur-md">
        <div className="hidden lg:flex items-center gap-3">
          ...
          <div className="flex flex-col leading-none">
            <span className="font-black tracking-[0.2em] text-sm text-zinc-100">STONIC 2.0</span>
